...
QT_MOC_LITERAL(1, 14, 11), // "handChanged"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 14) // "previewChanged"

    },
    "NotifyManager\0handChanged\0\0previewChanged"
};
...
void NotifyManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (NotifyManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NotifyManager::handChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (NotifyManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NotifyManager::previewChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NotifyManager::handChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void NotifyManager::previewChanged()
{
